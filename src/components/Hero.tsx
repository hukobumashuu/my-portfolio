...
const LINKS = [
  ...
  { label: "email", href: "mailto:matthew.jacob@email.com" },
];

export function Hero() {
  return (
    <section id="home" className="grid scroll-mt-20 grid-cols-1 gap-8 py-4 sm:grid-cols-[1fr_150px] sm:gap-10">
      <div className="flex flex-col justify-center">
        ...
        <p className="mb-3 text-[15px] leading-relaxed text-ink-secondary">
          I build web apps end to end, from database to UI. Recently wrapped
          a software engineering internship, and now looking for full-time
          roles.
        </p>
